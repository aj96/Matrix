/*
This program allows the user to input a matrix in row-major order.
...
in the correct format. So it is best not to try this code on sololearn.com
If you manage to break my program or it behaves in an unusual way, please
tell me.
